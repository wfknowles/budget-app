...
let db;
// establish a connection to IndexedDB database called 'budget-app' and set it to version 1
...
function saveRecord(record) {
    // open a new dbtransaction with the database with read and write permissions 
